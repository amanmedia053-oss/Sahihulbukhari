...
const SplashScreen = ({ onFinish, themeColor }: { onFinish: () => void, themeColor: string }) => {
  useEffect(() => {
    ...
    >
      ...
      >
        <div className="w-32 h-32 bg-white rounded-full flex items-center justify-center shadow-2xl">
          <AnimatedIcon icon={Book} className="w-16 h-16" color={themeColor} />
        </div>
      </motion.div>
      <motion.h1 
...
export default function App() {
  ...
  useEffect(() => {
    ...
    StatusBar.setBackgroundColor({ color: settings.themeColor }).catch(() => {});
    ...
    (metaThemeColor as HTMLMetaElement).content = settings.themeColor;
  }, [settings]);
        ...
        {books.map((book, i) => (
          ...
          >
            ...
            <div className="flex-1 text-right">
              ...
              <p className="text-xs text-slate-400" dir="rtl">{book.name}</p>
            </div>
    ...
    <div className="p-4 space-y-6" dir="rtl">
      <div className="flex items-center gap-4 mb-2">
        ...
        <div className="text-right">
          ...
          <p className="text-xs text-slate-400" dir="rtl">{selectedBook?.name}</p>
        </div>
      </div>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8">
          <div className="space-y-2 text-right">
            ...
            <p className="text-sm text-slate-400" dir="rtl">{selectedHadith.Bab}</p>
          </div>

          <div 
            className="text-right leading-relaxed text-slate-800" 
            dir="rtl"
  ...
  const AboutView = () => (
    <div className="p-4 space-y-6 pb-20" dir="rtl">
      <div className="flex flex-col items-center text-center space-y-4 py-6">
        <div 
          className="w-20 h-20 rounded-3xl flex items-center justify-center shadow-xl overflow-hidden relative"
          style={{ backgroundColor: settings.themeColor, shadowColor: `${settings.themeColor}40` }}
        >
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white rounded-3xl p-5 border border-slate-100 shadow-sm">
          <h3 className="font-bold mb-1" style={{ color: settings.themeColor }}>کاريال جوړوونکی:</h3>
          <p className="text-lg font-bold mb-4">عبیدالله غفاري</p>
          <div className="flex flex-wrap gap-2">
            <a href="mailto:example@gmail.com" className="p-2 bg-slate-50 rounded-xl text-slate-600 transition-colors" style={{ '--hover-color': settings.themeColor } as any}>
              <Mail className="w-5 h-5 hover:text-[var(--hover-color)]" />
            </a>
            <a href="https://wa.me/93700000000" className="p-2 bg-slate-50 rounded-xl text-slate-600 transition-colors" style={{ '--hover-color': settings.themeColor } as any}>
              <MessageCircle className="w-5 h-5 hover:text-[var(--hover-color)]" />
            </a>
            <a href="https://t.me/ObaidullahGhaffari" className="p-2 bg-slate-50 rounded-xl text-slate-600 transition-colors" style={{ '--hover-color': settings.themeColor } as any}>
              <Send className="w-5 h-5 hover:text-[var(--hover-color)]" />
            </a>
            <a href="https://facebook.com/ObaidullahGhaffari" className="p-2 bg-slate-50 rounded-xl text-slate-600 transition-colors" style={{ '--hover-color': settings.themeColor } as any}>
              <Facebook className="w-5 h-5 hover:text-[var(--hover-color)]" />
            </a>
          </div>
        </div>
        ...
        {/* Contributor Section */}
        <div className="bg-white rounded-3xl p-5 border border-slate-100 shadow-sm">
          <h3 className="font-bold mb-1" style={{ color: settings.themeColor }}>مرسته کوونکی:</h3>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <a href="https://t.me/DrFaraidoonAhrar" className="p-2 bg-slate-50 rounded-xl text-slate-600 transition-colors" style={{ '--hover-color': settings.themeColor } as any}>
              <Send className="w-5 h-5 hover:text-[var(--hover-color)]" />
            </a>
            <a href="https://facebook.com/DrFaraidoonAhrar" className="p-2 bg-slate-50 rounded-xl text-slate-600 transition-colors" style={{ '--hover-color': settings.themeColor } as any}>
              <Facebook className="w-5 h-5 hover:text-[var(--hover-color)]" />
            </a>
          </div>
        </div>
        ...
        {/* Publisher Section */}
        <div className="bg-white rounded-3xl p-5 border border-slate-100 shadow-sm">
          <h3 className="font-bold mb-1" style={{ color: settings.themeColor }}>نشروونکې اداره:</h3>
          <p className="text-lg font-bold mb-4">د اسلامي کاريالونو څانګه</p>
          <a 
            href="https://t.me/IslamicAppsDept" 
      ...
      <div className="pt-6 space-y-3">
        <button 
          className="w-full py-4 text-white rounded-2xl font-bold flex items-center justify-center gap-2 shadow-lg"
          style={{ backgroundColor: settings.themeColor, shadowColor: `${settings.themeColor}40` }}
        >
        ...
        <button 
          onClick={() => {
            if (navigator.share) {
              navigator.share({
                title: "صحیح البخاري اپلیکیشن",
                text: "د صحیح البخاري احادیثو ټولګه په پښتو ژبه کې. همدا اوس یې ډاونلوډ کړئ!",
                url: window.location.href
              });
            }
          }}
          className="w-full py-4 bg-slate-100 rounded-2xl font-bold flex items-center justify-center gap-2"
        >
          <Share2 className="w-5 h-5" style={{ color: settings.themeColor }} />
          اپلیکیشن شریک کړئ
        </button>
      </div>
    </div>
  ...
  if (loading) return <SplashScreen onFinish={() => setLoading(false)} themeColor={settings.themeColor} />;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
        ...
        {showExitDialog && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            >
              ...
              >
                <Info className="w-10 h-10" style={{ color: settings.themeColor }} />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <button 
                  ...
                  className="py-4 text-white rounded-2xl font-bold shadow-lg"
                  style={{ backgroundColor: settings.themeColor, shadowColor: `${settings.themeColor}40` }}
                >
                  هو، وځم
                </button>
      ...
      {view !== 'hadith' && (
        <nav 
          className="sticky bottom-0 z-30 bg-white border-t border-slate-100 px-6 py-3 flex justify-between items-center" 
          dir="rtl"
